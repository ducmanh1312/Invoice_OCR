...
import sys
sys.path.append(".")
from src.CRAFT import CRAFTModel, draw_boxes, draw_polygons, boxes_area, polygons_area
...
def rotation_image(boxes, img):
    ...
    for box in boxes:
        ...
        box_ratio = abs(y1 - y2)  / abs(x1 - x2) # height/width
...
if __name__ == '__main__':
    img_path = 'Invoice_Segmentation-7/test/mcocr_public_145014sgzjh_jpg.rf.a43b8fdba56e8325c7bb4f34a5d6a6aa.jpg'
    img = Image.open(img_path)
    text_det = TextDetection(device = 'cpu')
